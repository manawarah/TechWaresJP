...
<body>
    ...
    <main>
        ...
        <div>
            ...
            <input type="text" name="nome" placeholder="Digite o nome do cartão *" required>
            <input type="number" name="numero" placeholder="Digite o número do cartão *" required>
            ...
            <div class="box-icons">
                ...
                <i class="fa-brands fa-pix icon-buy" title="Pix" onclick="pix()"></i>
            </div>
